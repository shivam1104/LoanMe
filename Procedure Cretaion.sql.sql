...
DROP TYPE PAL_SVM_TRAINING_DATA_T;
CREATE TYPE PAL_SVM_TRAINING_DATA_T AS TABLE (
id BIGINT ,
...
INSERT INTO PAL_SVM_PDATA_TBL VALUES (1,'PRGOEL','PAL_SVM_TRAINING_DATA_T','IN');
...
CREATE COLUMN TABLE PAL_SVM_TRAINING_TBL LIKE PAL_SVM_TRAINING_DATA_T;

insert into PAL_SVM_TRAINING_TBL
select * from "PRGOEL"."TBL_INPUT_DATA";
